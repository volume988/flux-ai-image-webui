...
export default async function GenerationPage({
    ...
    const {
                ...
                pageSize,
                count
            } = await getUserGeneratedList(userId,1,1);
    return (
                       ...
                       <div class="w-full lg:w-4/12 px-4 lg:order-1">
                         <div class="flex justify-center py-4 lg:pt-4 pt-8">
                           <div class="mr-4 p-3 text-center">
                             <span class="text-xl font-bold block uppercase tracking-wide text-blueGray-600">{count}</span><span class="text-sm text-blueGray-400">Photos</span>
                           </div>
