...
export default async function ExploreLayout({
  children
    ...
    return (
          <div>
             <section class="relative max-w-[85rem] mx-auto mt-20 px-4 sm:px-6 lg:px-8 pb-10 lg:pb-16 bg-blueGray-200">
                     ...
                     <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg ">
                       <div class="px-6">
                         <div class="flex flex-wrap justify-center">
                           ...
                           <div class="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center bg-red">
                             <div class="py-6 px-3 mt-6 sm:mt-0">
                           ...
                           <div class="w-full lg:w-4/12 px-4 lg:order-1">
                             <div class="flex justify-center py-4 lg:pt-4 pt-8">
                               <div class="mr-4 p-3 text-center">
                                 <span class="text-xl font-bold block uppercase tracking-wide text-blueGray-600">99</span><span class="text-sm text-blueGray-400">Images</span>
                               </div>
                               <div class="lg:mr-4 p-3 text-center">
                                 <span class="text-xl font-bold block uppercase tracking-wide text-blueGray-600">99</span><span class="text-sm text-blueGray-400">Credits</span>
                               </div>
                             </div>
                           </div>
                         </div>
