...
export const Image = <T extends ImageExtended>({
  ...
  return (
    <a
      className="ReactGridGallery_tile group relative block rounded-xl overflow-hidden"
    ...
    >
      ...
      {!!item.customOverlay && (
        <div
          ...
          className="ReactGridGallery_custom-overlay transition-opacity duration-500 ease-in-out"
      ...
      >
        {ThumbnailImageComponent ? (
          ...
          <img key={index} {...thumbnailProps} className="group-hover:scale-105 group-focus:scale-105 transition-transform duration-500 ease-in-out " />
        )}
      </div>
