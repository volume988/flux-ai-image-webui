    ...
    <section className="bg-white dark:bg-neutral-900">
        <div className="max-w-[85rem] mx-auto gap-8 items-center py-8 px-4 sm:px-6 lg:px-8 xl:gap-16 md:grid md:grid-cols-2 sm:py-16">
            ...
            <div className="mt-4 md:mt-0">
                ...
                <a href="/image-generator" className="inline-flex items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-blue-900">
